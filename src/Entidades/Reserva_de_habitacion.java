...
public class Reserva_de_habitacion {
	...
	public Reserva_de_habitacion(int id_reserva_de_habitacion, int id_habitacion, String nombre_usuario,
			Date fecha_inicio, Date fecha_final, String detalles, Boolean estado) {
		super();
